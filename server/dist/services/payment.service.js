...
exports.PaymentService = exports.AD_PLANS = void 0;
...
class PaymentService {
     ...
     */
    static isConfigured() {
        return Boolean(env_js_1.ENV.RAZORPAY_KEY_ID && env_js_1.ENV.RAZORPAY_KEY_SECRET);
    }
    static getProviderName() {
        if (env_js_1.ENV.RAZORPAY_KEY_ID)
            return 'Razorpay';
        return 'None (Future Payment Architecture Ready)';
    }
    static getPlans() {
        return exports.AD_PLANS;
    }
    /**
     ...
     */
    static async createOrder(planId, propertyId, userId) {
        if (!this.isConfigured()) {
            return {
                ...
                plan: exports.AD_PLANS.find(p => p.id === planId) || null,
            };
        }
